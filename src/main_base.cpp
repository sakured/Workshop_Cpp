...
//         }
//     }
//     new_image.save("output/exo21.png"); 
...
//                     int real_x_offset{x_offset};
//                     int real_y_offset{y_offset};
//                     if (x+real_x_offset<0 || x+real_x_offset>=photo.width())
//                     {
//                         real_x_offset = 0;
//                     }
//                     if (y+real_y_offset<0 || y+real_y_offset>=photo.height())
//                     {
//                         real_y_offset = 0;
//                     }
//                     sum += photo.pixel(x+real_x_offset,y+real_y_offset);
//                 }
//             }
//             sum /= pow(2*size+1,2);
//             new_image.pixel(x,y)=sum;
...
//         for (int y{0}; y < photo.height(); y++)
//         {
//             photo.pixel(x, y).r = new_image.pixel(x, y).r - new_image_2.pixel(x, y).r;
//             photo.pixel(x, y).g = new_image.pixel(x, y).g - new_image_2.pixel(x, y).g;
//             photo.pixel(x, y).b = new_image.pixel(x, y).b - new_image_2.pixel(x, y).b;
//         }
//     }
//     photo.save("output/exo23.png");
// }  
